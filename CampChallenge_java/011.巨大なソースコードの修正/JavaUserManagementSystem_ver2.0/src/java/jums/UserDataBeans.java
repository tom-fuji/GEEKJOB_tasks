...
public class UserDataBeans implements Serializable{
    ...
    public void UD2DTOMapping(UserDataDTO udd){
        if(this.name.equals("") != true){udd.setName(this.name);}
        ...
        if(this.tell.equals("") != true){udd.setTell(this.tell);}
        if(this.type != 0){udd.setType(this.type);}
        if(this.comment.equals("") != true){udd.setComment(this.comment);}
    }
