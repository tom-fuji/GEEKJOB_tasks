...
public final class insertconfirm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  //タスク3.UserDataBeansのクラスを利用する
      ...
      out.write("        \n");
      out.write("        名前:");
      out.print(userbeans.getName());
      out.write("<br>\n");
      out.write("        生年月日:");
      out.print( userbeans.getYear()+"年"+ userbeans.getMonth()+"月"+userbeans.getDay()+"日");
      out.write("<br>\n");
      out.write("        種別:");
      out.print( userbeans.getType());
      out.write("<br>\n");
      out.write("        電話番号:");
      out.print( userbeans.getTell());
      out.write("<br>\n");
      out.write("        自己紹介:");
      out.print( userbeans.getComment());
      out.write("<br>\n");
      ...
      out.write("\n");
      out.write("        職業種別の入力が不完全です<br>\n");
      out.write("        ");
}if(userbeans.getTell().equals("")){ 
      out.write("\n");
      out.write("        電話番号の入力が不完全です<br>\n");
      out.write("        ");
}if(userbeans.getComment().equals("")){
      out.write("\n");
      out.write("        自己紹介の入力が不完全です<br>\n");
      out.write("        ");
 }
      out.write("\n");
      out.write("        \n");
